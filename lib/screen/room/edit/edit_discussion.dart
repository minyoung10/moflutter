...
class EditDiscussion extends StatefulWidget {
  final String roomId;
  final String docId;
  ...
  @override
  State<EditDiscussion> createState() => _EditDiscussionState();
}

class _EditDiscussionState extends State<EditDiscussion> {
