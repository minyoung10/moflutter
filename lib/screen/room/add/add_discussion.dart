...
class AddDisussion extends StatefulWidget {
  final String id;
  final String job;
  ...
  @override
  State<AddDisussion> createState() => _AddDisussionState();
}

class _AddDisussionState extends State<AddDisussion> {
